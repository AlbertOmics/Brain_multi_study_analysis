...
create_age_sub_category <- function(x){
  ...
  x$age_class <-  gsub('(e_?)|(e16.5)', 'embryo',x$age_class )
  x$age_class <-  gsub('(m4)|(m5-9)|(m7)|(m8)', 'adult',x$age_class )
  x$age_class <-  gsub('(p25)|(p42)', 'adolescent',x$age_class )
  x$age_class <-  gsub('(p42-p56)|(p55)', 'young adult',x$age_class )
  x
}
