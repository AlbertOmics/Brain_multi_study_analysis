...
```{r}
<<<<<<< HEAD:data_exploration/Explore_better_curated_data.Rmd
<<<<<<< HEAD:data_exploration/Explore_better_curated_data.Rmd



=======
>>>>>>> parent of b8481f6 (Add stages of life):tutorial/Explore_better_curated_data.Rmd
=======
>>>>>>> parent of b8481f6 (Add stages of life):tutorial/Explore_better_curated_data.Rmd
...
df <- as.data.frame(colData(joined_filtered_data)[, c("sra_attribute.Sex", "sra_attribute.age","sra_attribute.genotype","sra_attribute.tissue","study")])
colnames(df) <- c("Gender", "Age", "Genotype", "Tissue", "Project")
...
```{r}
  ...
  mod <- model.matrix(~ Predicted_sex +  sra_attribute.age + sra_attribute.genotype + sra_attribute.tissue,
    data = colData(joined_filtered_data)
)
...
<<<<<<< HEAD:data_exploration/Explore_better_curated_data.Rmd
<<<<<<< HEAD:data_exploration/Explore_better_curated_data.Rmd
df <- as.data.frame(colData(joined_filtered_data)[, c("Predicted_sex","sra_attribute.tissue")])
colnames(df) <- c("Gender","Tissue")
=======
df <- as.data.frame(colData(joined_filtered_data)[, c("Predicted_sex", "sra_attribute.age","sra_attribute.tissue")])
colnames(df) <- c("Gender", "Age","Tissue")
>>>>>>> parent of b8481f6 (Add stages of life):tutorial/Explore_better_curated_data.Rmd
=======
df <- as.data.frame(colData(joined_filtered_data)[, c("Predicted_sex", "sra_attribute.age","sra_attribute.tissue")])
colnames(df) <- c("Gender", "Age","Tissue")
